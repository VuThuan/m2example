 ...
 */
namespace Bdcrops\Afterpay\Model\Cron;

use Bdcrops\Afterpay\Model\Adapter\AfterpayTotalLimit as AfterpayTotalLimit;
    ...
    private function _updateDefault()
    {
        ...
        if (array_key_exists('errorCode', $response)) {
            ...
            foreach ($response as $result) {
                if ($result['type'] === \Bdcrops\Afterpay\Model\Payovertime::AFTERPAY_PAYMENT_TYPE_CODE_V1) {
            ...
            $this->_resourceConfig->saveConfig(
                'payment/' . \Bdcrops\Afterpay\Model\Payovertime::METHOD_CODE . '/' . \Bdcrops\Afterpay\Model\Config\Payovertime::MIN_TOTAL_LIMIT,
                $minTotal,
                'default',
                0
            );
            ...
            $this->_resourceConfig->saveConfig(
                'payment/' . \Bdcrops\Afterpay\Model\Payovertime::METHOD_CODE . '/' . \Bdcrops\Afterpay\Model\Config\Payovertime::MAX_TOTAL_LIMIT,
                $maxTotal,
                'default',
                0
            );
