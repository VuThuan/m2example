 ...
 */
namespace Bdcrops\Afterpay\Model\Config;

use Bdcrops\Afterpay\Model\Adapter\ApiMode;
...
/**
 * Class Payovertime
 * @package Bdcrops\Afterpay\Model\Config
 */
class Payovertime
{
    /**
    ...
    protected function _getConfigData($path, $override = [])
    {
        ...
        if (!empty($website_id) && $website_id) {
            return $this->scopeConfig->getValue('payment/' . \Bdcrops\Afterpay\Model\Payovertime::METHOD_CODE . '/' . $path, \Magento\Store\Model\ScopeInterface::SCOPE_WEBSITES, $website_id);
        } else {
            // var_dump($this->scopeConfig->getValue('payment/' . \Bdcrops\Afterpay\Model\Payovertime::METHOD_CODE . '/' . $path, 'default'));
            return $this->scopeConfig->getValue('payment/' . \Bdcrops\Afterpay\Model\Payovertime::METHOD_CODE . '/' . $path, 'default');
        }
    }
