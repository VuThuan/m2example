 ...
 */
namespace Bdcrops\Afterpay\Model\Adapter\Afterpay;
...
/**
 * Class Call
 * @package Bdcrops\Afterpay\Model\Adapter\Afterpay
 */
class Call
{
    /**
     ...
     * @return \Bdcrops\Afterpay\Model\Adapter\Bdcrops\AfterpayResponse
    ...
    public function send($url, $body = false, $method = \Magento\Framework\HTTP\ZendClient::GET, $override = [])
    {
        ...
        if ($this->afterpayConfig->isHTTPHeaderSupportEnabled()) {
            $client = $objectManager->get('Bdcrops\Afterpay\Model\Adapter\Bdcrops\AfterpayClient');
        }
        else {
