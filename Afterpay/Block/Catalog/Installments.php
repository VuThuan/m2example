 ...
 */
namespace Bdcrops\Afterpay\Block\Catalog;
...
use Bdcrops\Afterpay\Model\Payovertime as AfterpayPayovertime;
...
class Installments extends Template
{
    ...
    public function getInstalmentText()
    {
        ...
        $assetsPath = $this->componentRegistrar->getPath(ComponentRegistrar::MODULE, 'Bdcrops_Afterpay');
        $assets_product_page = [];
