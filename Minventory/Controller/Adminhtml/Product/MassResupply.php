...
namespace Bdcrops\Minventory\Controller\Adminhtml\Product;
use \Magento\Framework\Controller\ResultFactory;

class MassResupply extends \Bdcrops\Minventory\Controller\Adminhtml\Product {
    protected $filter;
    ...
    public function __construct(
        ...
        \Bdcrops\Minventory\Model\Resupply $resupply
    ){
