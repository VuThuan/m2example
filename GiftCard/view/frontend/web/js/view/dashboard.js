...
define(
    [
        ...
        'Bdcrops_GiftCard/js/action/check-code-availability',
        'Bdcrops_GiftCard/js/action/redeem',
        'Bdcrops_GiftCard/js/action/add-list',
        'Bdcrops_GiftCard/js/action/save-settings',
        'mage/template',
        'text!Bdcrops_GiftCard/template/list/view.html',
    ...
    function ($, ko, Component, giftCard, checkCodeAvailability, redeemAction, addListAction, saveSettingsAction, mageTemplate, savedListViewTemplate, confirm, resolver) {
        ...
        return Component.extend({
            ...
            defaults: {
                template: 'Bdcrops_GiftCard/dashboard'
            },
