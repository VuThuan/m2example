...
define(
    [
        ...
        'Bdcrops_GiftCard/js/action/apply-gift-card',
        'Bdcrops_GiftCard/js/action/cancel-gift-card',
        'Bdcrops_GiftCard/js/action/apply-credit',
        'rjsResolver',
        'mage/translate',
        'mpIonRangeSlider'
    ],
    function ($, ko, Component, giftCard, applyCodeAction, cancelCodeAction, applyCreditAction, resolver, $t) {
        ...
        return Component.extend({
            defaults: {
                template: 'Bdcrops_GiftCard/checkout/cart'
            },
