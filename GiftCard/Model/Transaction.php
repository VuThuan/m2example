...
use Bdcrops\GiftCard\Model\GiftCard\Action as GiftCardAction;
...
class Transaction extends AbstractModel implements IdentityInterface
{
     ...
     * Cache
     */
    const CACHE_TAG = 'bdcrops_giftcard_transaction';
    ...
    {
        parent::_construct();
        $this->_init('Bdcrops\GiftCard\Model\ResourceModel\Transaction');
    }
    ...
    public function getTransactionsForCustomer($customerId)
    {
        ...
        $transactions->getSelect()
            ->join(
                ['cr' => $transactions->getTable('bdcrops_giftcard_credit')],
