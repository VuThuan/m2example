...
use Bdcrops\GiftCard\Model\Attribute\Backend\Amount;
use Bdcrops\GiftCard\Model\Attribute\Backend\MultiSelect;
use Bdcrops\GiftCard\Model\Attribute\Backend\Pattern;
use Bdcrops\GiftCard\Model\GiftCard\Template;
...
class InstallData implements InstallDataInterface
{
    ...
    /**
     * @var \Bdcrops\GiftCard\Setup\BlockFactory
     */
    protected $blockFactory;

    /**
     * @var \Bdcrops\GiftCard\Setup\TemplateFactory
     */
    ...
    public function install(ModuleDataSetupInterface $setup, ModuleContextInterface $context)
    {
        ...
        $catalogSetup->addAttribute(Product::ENTITY, 'gift_code_pattern', array_merge($this->getDefaultOptions(), [
            ...
            'input_renderer' => \Bdcrops\GiftCard\Block\Adminhtml\Product\Helper\Form\Config\Pattern::class,
            'required'       => true,
            'sort_order'     => 10
        ]));
        ...
        if (!$block->getId()) {
            $headBlock = [
                ...
                'stores'     => [0],
                'is_active'  => 1,
                'content'    => '<p><img src="{{media url="bdcrops/default/gift_product_banner.jpg"}}" alt="Gift Product Banner" width="100%" /></p>'
            ];
        ...
        $setup->getConnection()->insertMultiple($installer->getTable('bdcrops_giftcard_template'), $sampleTemplates);
