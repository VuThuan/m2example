...
namespace Bdcrops\GiftCard\Console\Command;
...
/**
 * Class Reset
 * @package Bdcrops\Security\Console\Command
 */
class Uninstall extends Command
{
    ...
    {
        $this->setName('giftcard:uninstall')->setDescription('Prepare for remove Bdcrops_GiftCard module');
    ...
    public function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        try {
            ...
            $this->moduleResource->getConnection()
                ->delete($this->moduleResource->getMainTable(), "module='Bdcrops_GiftCard'");
            $output->writeln('<info>Prepare remove Bdcrops_GiftCard module successfully</info>');
        } catch (Exception $e) {
