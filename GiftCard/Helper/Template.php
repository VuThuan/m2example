...
namespace Bdcrops\GiftCard\Helper;
...
/**
 * Class Template
 * @package Bdcrops\GiftCard\Helper
 */
class Template extends Data
{
    const TEMPLATE_MEDIA_PATH = 'bdcrops/giftcard';
     ...
     * @param $templateId
     *
     * @return \Bdcrops\GiftCard\Model\Template | null
     */
        ...
        foreach ($design as $id => &$field) {
            ...
            switch ($id) {
                ...
                case 'logo':
                    ...
                    break;
                case 'barcode':
                    $field['src'] = $this->_assetRepo->getUrl('Bdcrops_GiftCard::images/barcode.png');
                    break;
                case 'title':
    ...
    public function getTemplateFields()
    {
        return [
            'image'        => [
                'label' => __('Image'),
                'img'   => $this->_assetRepo->getUrl('Bdcrops_GiftCard::images/default.png')
            ],
            'logo'         => [
                'label' => __('Logo'),
            ...
            'barcode'      => [
                'label' => __('Barcode'),
                'img'   => $this->_assetRepo->getUrl('Bdcrops_GiftCard::images/barcode.png'),
                'css'   => [
                    'background-color' => '#fff',
                    'padding'          => '5px'
                ]
