...
namespace Bdcrops\GiftCard\Ui\DataProvider\Product\Modifier;
...
use Bdcrops\GiftCard\Helper\Product as ProductHelper;

/**
 * Class GiftCard
 * @package Bdcrops\GiftCard\Ui\DataProvider\Product\Modifier
 */
                    ...
                    'arguments' => [
                        'data' => [
                            'config' => [
                                ...
                                'component'         => 'Bdcrops_GiftCard/js/form/element/allow-amount-range',
                    ...
                    'arguments' => [
                        'data' => [
                            'config' => [
                                ...
                                'component'         => 'Bdcrops_GiftCard/js/form/element/text-use-config',
                                'componentType'     => Field::NAME,
