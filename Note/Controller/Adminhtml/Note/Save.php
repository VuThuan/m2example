...
class Save extends \Magento\Backend\App\Action
{
    ...
    public function execute()
    {
        ...
        if ($data) {
            ...
            $model = $this->_objectManager->create('Bdcrops\Note\Model\Note')->load($id);
            if (!$model->getId() && $id) {
            ...
            try {
                ...
                $this->dataPersistor->clear('bdcrops_note_note');
            ...
            $this->dataPersistor->set('bdcrops_note_note', $data);
